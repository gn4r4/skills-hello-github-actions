...
>![placeholder](https://github.com/gn4r4/skills-hello-github-actions/blob/main/images/1.png?raw=true)
...
>![placeholder](https://github.com/gn4r4/skills-hello-github-actions/blob/main/images/2.png?raw=true)
...
>![placeholder](https://github.com/gn4r4/skills-hello-github-actions/blob/main/images/3.png?raw=true)

Вносимо зміни у файл `README.md` (додано емодзі `🚀`).

>![placeholder](https://github.com/gn4r4/skills-hello-github-actions/blob/main/images/4.png?raw=true)

Відкрито новий `Pull Request` до гілки `main`.

>![placeholder](https://github.com/gn4r4/skills-hello-github-actions/blob/main/images/5.png?raw=true)
